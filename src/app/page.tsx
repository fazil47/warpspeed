        ...
        <section className="flex flex-row justify-evenly py-12 w-full px-12">
          <div className="flex mr-0 flex-col justify-center w-1/2">
            <h1 className="flex pl-16 justify-stretch text-center md:text-left text-6xl font-bold py-4 text-white">
              Welcome to the ultimate platform for creating 3d models and
              enhancing respective picture!
            </h1>
            <p className=" flex pl-16 justify-stretch  text-left text-lg py-4 text-white">
              Our website is designed to provide you with the tools and
            ...
            <div className="flex flex-col items-center justify-center">
              <Link href="/editor">
                <button className="h-12 w-64 mt-12 px-5 m-2 text-indigo-100 transition-colors duration-150 bg-indigo-700 rounded-lg focus:shadow-outline hover:bg-indigo-800">
                  Start
                </button>
              </Link>
            </div>
